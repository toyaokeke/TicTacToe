...
public class GameListener implements ActionListener, Constants {
	...
	@Override
	/**
	 * Responds to an ActionEvent triggered by pressing a button in the active
	 * player's window.
	 */
	...
	/**
	 * Tells the GUI to display a dialog box for the user to enter in the player
	 * name.
	 * 
	...
	/**
	 * Tells the GUI to display a dialog box for the user to enter in the server
	 * address.
	 * 
